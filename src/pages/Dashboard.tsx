...
import { Send, Plus, Minus, TrendingUp, Eye, EyeOff } from 'lucide-react'
...
const Dashboard: React.FC = () => {
  ...
  const { ref: heroRef, translateY: heroParallax } = useParallax({ speed: 0.3 })
  const { ref: cardsRef, translateY: cardsParallax } = useParallax({ speed: 0.5 })
