...
const Dashboard = () => {
  ...
  const { ref: heroRef, translateY: heroParallax } = useParallax({
    speed: 0.3,
  });
  const { ref: cardsRef, translateY: cardsParallax } = useParallax({
    speed: 0.5,
  });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-neutral-50 to-neutral-100">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(135deg, #0c3d66 0%, #075985 50%, #0ea5e9 100%)",
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 lg:px-6">
          <div className="flex justify-between items-start gap-4 mb-8">
            ...
            <button
              ...
              className="mt-2 p-3 bg-white/20 hover:bg-white/30 backdrop-blur text-white rounded-lg transition-smooth"
            >
              {showBalance ? (
          ...
          <div className="card p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-xs font-semibold text-accent-600 bg-accent-50 px-3 py-1 rounded-full">
                +
                {(
                  (stats.totalTransfers / (account?.balance / 100 || 1)) *
                  100
                ).toFixed(1)}
                %
              </span>
            ...
            <p className="text-2xl font-bold text-neutral-900">
              $
              {stats.totalTransfers.toLocaleString("en-US", {
          ...
          <div className="card p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-xs font-semibold text-accent-600 bg-accent-50 px-3 py-1 rounded-full">
                +
                {(
                  (stats.totalDeposits / (account?.balance / 100 || 1)) *
                  100
                ).toFixed(1)}
                %
              </span>
            ...
            <p className="text-2xl font-bold text-neutral-900">
              $
              {stats.totalDeposits.toLocaleString("en-US", {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2,
              })}
            </p>
          ...
          <div className="card p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-xs font-semibold text-accent-600 bg-accent-50 px-3 py-1 rounded-full">
                +
                {(
                  (stats.savingsGrowth / (account?.balance / 100 || 1)) *
                  100
                ).toFixed(1)}
                %
              </span>
            ...
            <p className="text-2xl font-bold text-neutral-900">
              $
              {stats.savingsGrowth.toLocaleString("en-US", {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2,
              })}
            </p>
